...
export const CHECKS = [
  ...
  },
  {
    ...
    source_query: "SELECT l.id AS entity_id, 1::bigint AS qty FROM fin.invoice_lines l WHERE l.source_type = 'RATED_USAGE'",
    comparison_query: "SELECT l.id AS entity_id, 1::bigint AS qty FROM fin.invoice_lines l JOIN fin.rated_usage r ON r.id = l.source_id WHERE l.source_type = 'RATED_USAGE'",
  },
  {
    check_code: 'R045',
    severity: 'HIGH',
